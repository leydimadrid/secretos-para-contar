...
namespace TeslaACDC.Data.Migrations
{
    ...
    [Migration("20250314190259_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeslaACDC.Data.Models.Audiolibro", b =>
                {
                    ...
                    b.Property<int>("NarradorId")
                        .HasColumnType("integer")
                        .HasColumnName("narrador_id");

                    b.Property<double>("TamañoMB")
            ...
            modelBuilder.Entity("TeslaACDC.Data.Models.Idioma", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TeslaACDC.Data.Models.Narrador", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("narrador", (string)null);
                });
            ...
            modelBuilder.Entity("TeslaACDC.Data.Models.Audiolibro", b =>
                {
                    b.HasOne("TeslaACDC.Data.Models.Idioma", "Idioma")
                        .WithMany()
                        .HasForeignKey("IdiomaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeslaACDC.Data.Models.Narrador", "Narrador")
                        .WithMany("Audiolibros")
            ...
            modelBuilder.Entity("TeslaACDC.Data.Models.LibroGenero", b =>
                {
                    ...
                    b.HasOne("TeslaACDC.Data.Models.Genero", null)
